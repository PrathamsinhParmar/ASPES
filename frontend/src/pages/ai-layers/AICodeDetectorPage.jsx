        ...
        <div className="space-y-8">
          ...
          <div className="bg-white dark:bg-slate-900 border border-gray-100 dark:border-slate-800 rounded-3xl p-8 shadow-sm">
            ...
            <div className="flex items-center gap-6">
              ...
              <span className="text-4xl font-bold text-gray-900 dark:text-white min-w-[80px] text-right">
                {probability}%
              </span>
            </div>
          </div>
          ...
          {/* Findings */}
          <div className="bg-white dark:bg-slate-900 border border-gray-100 dark:border-slate-800 rounded-3xl p-8 shadow-sm">
            <h2 className="text-xl font-bold text-gray-900 dark:text-white tracking-tight mb-8 flex items-center gap-3">
