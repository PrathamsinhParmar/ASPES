      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-white/70 dark:bg-slate-900/70 backdrop-blur-md p-5 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm relative z-10">
        ...
        {selectedGroup && (
          <button 
            ...
            className="px-6 py-3 rounded-2xl text-sm font-bold uppercase tracking-widest text-slate-500 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 hover:bg-slate-50 transition-all"
          >
            Back to Groups
          </button>
        )}
              ...
              {groups.map(g => (
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-xs font-medium text-slate-500 dark:text-slate-400">{g.project_count} Assigned Projects</p>
                  </div>
                </div>
              ))}
            </div>
          ...
          <div className="bg-white dark:bg-slate-900 p-8 rounded-3xl shadow-2xl relative z-10 w-full max-w-md border border-slate-200 dark:border-slate-800 animate-slide-up">
            ...
            <form onSubmit={handleCreateGroup}>
              ...
              <div className="flex justify-end gap-3 mt-8">
                ...
                <button type="submit" disabled={isSaving} className="px-6 py-2.5 text-xs font-medium text-white bg-indigo-600 rounded-xl hover:bg-indigo-700 disabled:opacity-50 shadow-md shadow-indigo-500/20">{isSaving ? 'Processing' : 'Create Group'}</button>
              </div>
            </form>
          </div>
        </div>
          ...
          <div className="bg-white dark:bg-slate-900 p-8 rounded-3xl shadow-2xl relative z-10 w-full max-w-md border border-slate-200 dark:border-slate-800 animate-slide-up">
            ...
            <div className="flex justify-end gap-3 mt-8">
              ...
              <button 
                ...
                disabled={isRemoving} 
                className="px-6 py-2.5 text-xs font-medium text-white bg-rose-600 rounded-xl hover:bg-rose-700 disabled:opacity-50 shadow-md shadow-rose-500/20 transition-all"
              >
