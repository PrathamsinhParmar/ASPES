        ...
        <div className="space-y-8">
          ...
          <div className="bg-white dark:bg-slate-900 border border-gray-100 dark:border-slate-800 rounded-3xl p-8 shadow-sm">
            <div className="flex items-center justify-between mb-4">
              <div>
                <h2 className="text-lg font-bold text-gray-900 dark:text-white tracking-tight">Report-to-Logic Alignment</h2>
              ...
              <span className="text-5xl font-bold text-cyan-600 dark:text-cyan-400">{Math.round(alignScore)}%</span>
            </div>
          ...
          <div className="bg-cyan-50 dark:bg-cyan-900/10 border border-cyan-100 dark:border-cyan-500/20 rounded-3xl p-8">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="font-bold text-cyan-900 dark:text-cyan-300 text-sm uppercase tracking-widest">
                Engine Synthesis
              </h3>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* Implemented */}
            <div className="bg-white dark:bg-slate-900 border border-gray-100 dark:border-slate-800 rounded-3xl p-8 shadow-sm">
              <h3 className="font-bold text-gray-900 dark:text-white text-sm uppercase tracking-widest mb-4 text-emerald-600 dark:text-emerald-400">
            ...
            {/* Missing */}
            <div className="bg-white dark:bg-slate-900 border border-gray-100 dark:border-slate-800 rounded-3xl p-8 shadow-sm">
              <h3 className="font-bold text-rose-500 dark:text-rose-400 text-sm uppercase tracking-widest mb-4">
          ...
          <div className="bg-gray-50 dark:bg-slate-800/50 border border-gray-100 dark:border-slate-700 rounded-2xl p-6">
            <h3 className="text-xs font-medium text-slate-600 dark:text-slate-400 mb-3">How This Layer Works</h3>
