      ...
      <div className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-md shadow-sm rounded-2xl overflow-hidden border border-slate-200 dark:border-slate-800 z-10">
        ...
        {projects.length === 0 ? (
          <div className="p-20 text-center bg-slate-50/20 dark:bg-slate-900/10 backdrop-blur-sm border-t border-slate-100 dark:border-slate-800/50">
            ...
            <h4 className="text-2xl font-bold text-slate-900 dark:text-white tracking-tight">No active projects yet</h4>
                  ...
                  <tr key={project.id} className="hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors group">
                    ...
                    <td className="px-5 py-4 whitespace-nowrap">
                       {project.total_score !== null && project.total_score !== undefined ? (
                         <span className={`text-sm font-bold ${project.total_score >= 80 ? 'text-emerald-600' : project.total_score >= 60 ? 'text-amber-600' : 'text-rose-600'}`}>
                    ...
                    <td className="px-5 py-4 whitespace-nowrap text-right text-sm">
                      <div className="flex justify-end items-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                        <button
                          ...
                          className="group relative overflow-hidden inline-flex items-center justify-center px-4 py-1.5 border-none shadow-[0_5px_15px_-5px_rgba(79,70,229,0.3)] text-xs font-medium rounded-lg text-white bg-gradient-to-r from-indigo-600 to-blue-600 hover:shadow-[0_8px_20px_-5px_rgba(79,70,229,0.4)] transition-all duration-300"
                        >
                  ...
                  <div className="mt-3 text-center sm:mt-0 sm:ml-6 sm:text-left">
                    ...
                    <div className="mt-4 space-y-3">
                      <p className="text-sm text-slate-500 dark:text-slate-400 font-medium">
                        You are about to delete <span className="font-bold text-slate-900 dark:text-white">&quot;{projectToDelete?.title}&quot;</span>. This action is catastrophic and cannot be reversed.
                      </p>
              ...
              <div className="bg-white dark:bg-slate-900 p-6 sm:p-8">
                <div className="flex items-center justify-between mb-8">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h3 className="text-xl font-bold text-slate-900 dark:text-white leading-tight">Edit Project Details</h3>
                      <p className="text-xs font-medium text-slate-500 dark:text-slate-400 mt-1">Refining Project Information</p>
                    </div>
                  </div>
                  <button 
                ...
                <form onSubmit={handleUpdateProject} className="space-y-6">
                  <div>
                    <label htmlFor="title" className="block text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest mb-2 ml-1">
                  ...
                  <div>
                    <label htmlFor="description" className="block text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest mb-2 ml-1">
                      Project Narrative
                    </label>
                    <textarea
                      id="description"
                  ...
                  <div className="pt-4 flex flex-col sm:flex-row gap-4">
                    <button
                      type="submit"
                      disabled={isSaving}
                      className="flex-1 inline-flex justify-center items-center rounded-2xl border-none shadow-[0_10px_30px_-10px_rgba(79,70,229,0.5)] px-8 py-4 bg-gradient-to-r from-indigo-600 via-indigo-500 to-blue-600 text-xs font-bold uppercase tracking-[0.2em] text-white hover:shadow-[0_15px_35px_-5px_rgba(79,70,229,0.6)] hover:-translate-y-1 active:scale-95 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed group relative overflow-hidden"
                    >
                      <div className="absolute inset-0 bg-white/20 translate-y-full group-hover:translate-y-0 transition-transform duration-300"></div>
                      <span className="relative flex items-center">
                        {isSaving ? (
