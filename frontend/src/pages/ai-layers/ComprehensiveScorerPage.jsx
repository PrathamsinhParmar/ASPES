        ...
        <div className="space-y-8">
            ...
            <div className="relative z-10 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6">
              <div>
                ...
                <div className="flex items-baseline gap-4">
                  <span className="text-[8rem] font-bold leading-none tracking-tighter text-blue-500">
              ...
              <div className="bg-white/5 backdrop-blur-3xl rounded-[2rem] p-8 border border-white/10 flex flex-col items-center justify-center min-w-[130px]">
                ...
                <span className="text-5xl font-bold text-white">{stats.grade}</span>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="bg-white dark:bg-slate-900 border border-gray-100 dark:border-slate-800 rounded-3xl p-8 shadow-sm">
              <h2 className="text-lg font-bold text-gray-900 dark:text-white tracking-tight mb-2">Logical Footprint</h2>
            ...
            {/* Bar */}
            <div className="bg-white dark:bg-slate-900 border border-gray-100 dark:border-slate-800 rounded-3xl p-8 shadow-sm">
              <h2 className="text-lg font-bold text-gray-900 dark:text-white tracking-tight mb-2">Weighted Contributions</h2>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {[
              ...
              <div key={i} className={`bg-${m.color}-50 dark:bg-${m.color}-900/10 border border-${m.color}-100 dark:border-${m.color}-500/20 rounded-2xl p-5 text-center transition-all duration-300 hover:scale-105 hover:shadow-lg`}>
                ...
                <p className={`text-2xl font-bold text-${m.color}-600 dark:text-${m.color}-400`}>{Math.round(m.score || 0)}%</p>
              </div>
            ))}
          </div>
        </div>
