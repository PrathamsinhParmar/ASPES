        ...
        <div className="space-y-8">
          ...
          <div className="bg-white dark:bg-slate-900 border border-gray-100 dark:border-slate-800 rounded-3xl p-8 shadow-sm">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-lg font-bold text-gray-900 dark:text-white tracking-tight">Documentation Score</h2>
              <span className="text-5xl font-bold text-emerald-600 dark:text-emerald-400">{Math.round(docScore)}%</span>
            </div>
          ...
          <div className="bg-white dark:bg-slate-900 border border-gray-100 dark:border-slate-800 rounded-3xl p-8 shadow-sm">
            <h2 className="text-lg font-bold text-gray-900 dark:text-white tracking-tight mb-6">Completeness Metrics</h2>
              ...
              {completenessMetrics.map(({ label, value }) => (
                <div key={label} className="py-3 border-b border-gray-50 dark:border-slate-800 last:border-0">
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <span className="text-sm font-bold text-gray-900 dark:text-white">{(value ?? 0).toFixed(1)}/100</span>
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-emerald-50 dark:bg-emerald-900/10 border border-emerald-100 dark:border-emerald-500/20 rounded-3xl p-8">
              <h3 className="font-bold text-emerald-900 dark:text-emerald-300 text-sm uppercase tracking-widest mb-4">
                Sections Present
              </h3>
